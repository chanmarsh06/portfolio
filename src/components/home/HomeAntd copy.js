    ...
    <>
      <style>{`
        ...
        @media (min-width: 576px) and (max-width: 767px) {
          ...
          .sm-social { justify-content: center !important; }
          .sm-buttons { justify-content: center !important; }
          .sm-title-center { justify-content: center !important; }
        }
        
        @media (min-width: 768px) {
          .desktop-spacing { margin-bottom: 24px !important; }
          .desktop-title { justify-content: flex-start !important; }
        }
        
        @media (min-width: 992px) {
          .lg-spacing { margin-bottom: 32px !important; }
        }
        
        @media (min-width: 1200px) {
          .xl-spacing { margin-bottom: 40px !important; }
        }
        
        @media (max-width: 576px) {
          .mobile-padding { padding: 0 16px !important; }
          .mobile-title { font-size: 1.5rem !important; }
          .mobile-subtitle { font-size: 1rem !important; }
          ...
          <Row gutter={[{ xs: 16, sm: 20, md: 24, lg: 32, xl: 40 }, { xs: 20, sm: 24, md: 32, lg: 40 }]} align="middle">
            <Col xs={24} sm={24} md={4} lg={3} xl={3} order={{ xs: 1, sm: 1, md: 1 }}>
              <div style={{
                ...
                <Space direction={{ xs: 'horizontal', sm: 'horizontal', md: 'vertical' }} size={{ xs: 'middle', sm: 'large', md: 'large' }} style={{ width: '100%' }} className="mobile-social sm-social">
            ...
            <Col xs={24} sm={24} md={14} lg={15} xl={15} order={{ xs: 3, sm: 3, md: 2 }}>
              <div style={{
                transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
                opacity: isVisible ? 1 : 0,
                transition: 'all 1s ease-out 0.3s'
              }}>
                <Space direction="vertical" size={{ xs: 'middle', sm: 'middle', md: 'large', lg: 'large' }} style={{ width: '100%' }}>
                  <div>
                    <Title level={1} className="mobile-title desktop-title mobile-title-center sm-center sm-title-center" style={{ 
                    ...
                    <Title level={3} className="mobile-subtitle desktop-spacing lg-spacing xl-spacing" style={{ 
                  ...
                  <Space size={{ xs: 'small', sm: 'middle', md: 'large', lg: 'large' }} wrap className="mobile-buttons sm-center sm-buttons" style={{ justifyContent: 'flex-start', marginTop: '8px' }}>
                    <Button
                      type="primary"
                      size={{ xs: 'middle', sm: 'middle', md: 'large', lg: 'large' }}
            ...
            <Col xs={24} sm={24} md={6} lg={6} xl={6} order={{ xs: 2, sm: 2, md: 3 }} style={{ textAlign: 'center', marginBottom: '24px' }}>
              <div style={{
